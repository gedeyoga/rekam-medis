<template>
    <div class="medicalrecord-list">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">List Rekam Medis</h1>
...
export default {
    ...
    methods: {
        queryServer(customProperties) {
            ...
            axios.get(route("api.medicalrecord.index"), properties).then((response) => {
        ...
        onDelete(row) {
            ...
            .then(() => {
                ...
                axios
                    .delete(
                        route("api.medicalrecord.destroy", {
                            medicalrecord: row.id,
                        })
                    )
                    .then((response) => {
                        this.tableIsLoading = false;
...
<style>
.medicalrecord-list .filter-text {
